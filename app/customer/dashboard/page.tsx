            ...
            <div className="flex-1 min-w-0 pr-1.5">
              <p className="font-semibold text-[12px] sm:text-[13px] leading-snug flex flex-wrap items-center gap-x-1 gap-y-0">
                ...
                <span className="inline-flex items-center">
                  ...
                  >
                    <path
                      d="M12.3 22.15C11.43 22.15 10.56 22.01 9.71 21.73L8.14 21.21L6.75 22.31C6.31 22.66 5.86 22.86 5.39 22.86C4.85 22.86 4.39 22.6 3.99 22.1C3.59 21.61 3.39 21.06 3.39 20.47V18.79L2.12 17.61C1.65 17.16 1.3 16.71 1.05 16.21C0.8 15.72 0.67 15.22 0.67 14.71C0.67 14.12 0.81 13.56 1.1 13.06C1.39 12.56 1.77 12.13 2.25 11.75L3.39 10.87V9.16C3.39 8.23 3.65 7.42 4.16 6.74C4.67 6.06 5.34 5.56 6.16 5.24L7.54 4.7L8.32 3.31C8.71 2.62 9.2 2.11 9.79 1.76C10.38 1.41 11.03 1.24 11.73 1.24C12.43 1.24 13.08 1.41 13.67 1.76C14.26 2.11 14.75 2.62 15.14 3.31L15.92 4.7L17.3 5.24C18.12 5.56 18.79 6.06 19.3 6.74C19.81 7.42 20.07 8.23 20.07 9.16V10.87L21.21 11.75C21.69 12.13 22.07 12.56 22.36 13.06C22.65 13.56 22.79 14.12 22.79 14.71C22.79 15.22 22.66 15.72 22.41 16.21C22.16 16.71 21.81 17.16 21.34 17.61L20.07 18.79V20.47C20.07 21.06 19.87 21.61 19.47 22.1C19.07 22.6 18.61 22.86 18.07 22.86C17.6 22.86 17.15 22.66 16.71 22.31L15.32 21.21L13.75 21.73C12.9 22.01 12.03 22.15 11.16 22.15Z"
                      fill="#0084FF"
                    />
                    <path
                      d="M10.2 15.8C10.02 15.8 9.85 15.73 9.72 15.6L6.8 12.68C6.67 12.55 6.6 12.38 6.6 12.2C6.6 12.02 6.67 11.85 6.8 11.72L8.2 10.32C8.33 10.19 8.5 10.12 8.68 10.12C8.86 10.12 9.03 10.19 9.16 10.32L10.2 11.36L16.2 5.36C16.33 5.23 16.5 5.16 16.68 5.16C16.86 5.16 17.03 5.23 17.16 5.36L18.56 6.76C18.69 6.89 18.76 7.06 18.76 7.24C18.76 7.42 18.69 7.59 18.56 7.72L10.68 15.6C10.55 15.73 10.38 15.8 10.2 15.8Z"
                      fill="white"
                      transform="translate(-0.7 2.2)"
                    />
                  </svg>
                </span>
              </p>
